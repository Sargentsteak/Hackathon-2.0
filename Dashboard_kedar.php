...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 mb-2">
            <a href="Categories.php" class="btn btn-info btn-block">
              <i class="fas fa-folder-plus"></i>Projects
            </a>
          </div>
          <div class="col-lg-3 mb-2 ">
          ...
          <div class="col-lg-3 mb-2">
            <a href="Comments.php" class="btn btn-success btn-block">
              <i class="fas fa-check"></i> Queries
            </a>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 d-none d-md-block">
          <div class="card text-center bg-dark text-white mb-3">
            <div class="card-body">
              <h1 class="lead">Project Status</h1>
              <h4 class="display-5">
        ...
        <div class="col-lg-10">
          ...
          <table class="table table-striped table-hover">
            <thead class="thead-dark">
              <tr>
                <th class="FieldInfo">No.</th>
                <th class="FieldInfo">Project</th>
                <th class="FieldInfo">Reg.Date</th>
                <th class="FieldInfo">Company</th>
                <th class="FieldInfo">Lauch date</th>
                <th class="FieldInfo">Priority</th>
                <th class="FieldInfo">Lead</th>
                <th class="FieldInfo">Actions</th>
              </tr>
            </thead>
            <?php
            $SrNo = 0;
    ...
    <!-- FOOTER -->
    <div style="height:10px; background:#27aae1;margin-top: 300px;"></div>
